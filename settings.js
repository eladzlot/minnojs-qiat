define(['https://pcplab.sfo2.digitaloceanspaces.com/common/qiat.js'], function (qiatExtension) {
    return qiatExtension({
        ...
        instCategoryInventory: [
            ...
            '<tr style="height: 31px;">',
            '<td style="width: 362px; height: 31px;"><span >Sentences describing <%= current.category1.title %>: </span></td>',
            '<td style="width: 35px; height: 31px;"></td>',
            '<td style="width: 366px; height: 31px;"><span>Sentences describing <%= current.category2.title %>: </span></td>',
            '</tr>',
